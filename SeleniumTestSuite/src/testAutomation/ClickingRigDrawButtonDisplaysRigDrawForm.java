...
//Test ID 4
public class ClickingRigDrawButtonDisplaysRigDrawForm {
	...
	@Test
	public void testClickingRigDrawButtonDisplaysRigDrawForm() throws Exception {
		driver.get(baseUrl + "/webapp/");
		driver.findElement(By.xpath("(//input[@name='numPlayers'])[3]")).click();
		driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
		driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
		driver.findElement(By.xpath("/html/body/div[3]/form/input[4]")).click();
		assertEquals("PokerApp | Rig Draw", driver.getTitle());
	}
