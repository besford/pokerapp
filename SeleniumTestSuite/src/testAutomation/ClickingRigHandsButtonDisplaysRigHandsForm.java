...
//Test ID 4
public class ClickingRigHandsButtonDisplaysRigHandsForm {
	...
	@Test
	public void ClickingClickingRigHandsButtonDisplaysRigHandsForm() throws Exception {
		...
		assertEquals("PokerApp | Rig Hands", driver.getTitle());
	}
