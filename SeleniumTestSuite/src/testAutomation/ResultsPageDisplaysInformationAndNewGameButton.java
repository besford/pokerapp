...
//Test ID 5
public class ResultsPageDisplaysInformationAndNewGameButton {
	...
	@Test
	public void testResultsPageDisplaysInformationAndNewGameButton() throws Exception {
		driver.get(baseUrl + "/webapp/");
		driver.findElement(By.xpath("(//input[@name='numPlayers'])[3]")).click();
		driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
		driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
		driver.findElement(By.xpath("/html/body/div[3]/form/input[1]")).click();
		driver.findElement(By.xpath("/html/body/div[3]/form/input[1]")).click();
		driver.findElement(By.xpath("/html/body/div[3]/form/input[1]")).click();
		driver.findElement(By.xpath("/html/body/div[3]/form/input[1]")).click();
		assertEquals("PokerApp | Results", driver.getTitle());
		assertTrue(isElementPresent(By.cssSelector("div")));
		assertTrue(isElementPresent(By.xpath("//div[2]")));
		assertTrue(isElementPresent(By.name("reset")));
	}
