...
//Test ID 5
public class ResultsPageStartNewGameAndDisplaysNewGame {
	...
	@Test
	public void testResultsPageStartNewGameAndDisplaysNewGame() throws Exception {
		...
		driver.findElement(By.xpath("/html/body/div[3]/form/input[1]")).click();
		driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
		assertEquals("PokerApp", driver.getTitle());
	}
